...
const RoomDetails: React.FC = () => {
  ...
  return (
    <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
      ...
      {/* Room Highlights */}
      <div className="flex flex-col md:flex-row md:justify md:justify-between mt-10">
      ...
      <form
        className="flex flex-col md:flex-row items-center md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0.15)]
      ...
      <div className="mt-25 space-y-4">
        {roomCommonData.map((spec: RoomCommonData, index: number) => (
